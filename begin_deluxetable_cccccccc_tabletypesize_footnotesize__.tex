...
\tablewidth{0pt}
 ...
 \enddata
 \vspace{-0.8cm}
 \tablecomments{Luminosity dependent quasar clustering using a cross-correlation technique between CS82 galaxies ($M<23.5$) and SDSS, BOSS, and 2SLAQ quasars~($0.5$) }
\end{deluxetable}
